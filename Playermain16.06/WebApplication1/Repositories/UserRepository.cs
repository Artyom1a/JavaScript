...
namespace WebApplication1.Repositories
{
    public class UserRepository : BaseRepository
    {
        ...
        private const string SQL_insertItem = "insert into Users(NAME,Email,Password) values(?, ?, ?);";
        ...
        public void WriteNew(User user)
        {
            try
            {
                ...
                DynamicQuery(m_Connection, SQL_insertItem, user.Name, user.Email, user.Password);
